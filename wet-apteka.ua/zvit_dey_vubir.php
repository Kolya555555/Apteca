...
<h1 align = "center">Сформовані заявки з <?= $date ?> по <?= $datee ?></h1></div>
<span class="noprint">
 <div align="center">  <form action="zvit_dey_vubir.php" method="post">
                        ...
                        <button class = "btn-buy" type="submit">Пошук заявок </button>
            </form> </div>
...
<div align="center">
   ...
   <?php
        $zakaz_ok = mysqli_query($connect, "SELECT * FROM `zakaz_ok` WHERE `Date` BETWEEN '$date' AND '$datee'");
